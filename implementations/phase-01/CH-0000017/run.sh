#!/bin/bash
# WE3 Challenge Implementation: CH-0000017
# Title: Public Key Cryptography #17
...
echo "=== WE3 Challenge CH-0000017 ==="
echo "Title: Public Key Cryptography #17"
echo "Category: CRYPTOGRAPHIC" 
echo "Difficulty: EASY"
echo "Description: RSA, ECC implementation with synthetic key testing (Challenge CH-0000017)"
echo ""
echo "SUCCESS CRITERIA:"
echo "- Signature verification"
echo "- Key generation validation"

echo ""
echo "DEPENDENCIES: "
echo "TAGS: rsa, ecc, public-key, synthetic-keys"
echo ""
