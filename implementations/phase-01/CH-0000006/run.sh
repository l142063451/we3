...
# Title: Special Function Computation #6
...
echo "=== WE3 Challenge CH-0000006 ==="
echo "Title: Special Function Computation #6"
echo "Category: MATHEMATICAL" 
echo "Difficulty: HARD"
echo "Description: Compute Bessel, gamma, elliptic functions with high precision (Challenge CH-0000006)"
echo ""
