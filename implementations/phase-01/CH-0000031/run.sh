#!/bin/bash
# WE3 Challenge Implementation: CH-0000031
# Title: String Algorithms #31
...
echo "=== WE3 Challenge CH-0000031 ==="
echo "Title: String Algorithms #31"
echo "Category: ALGORITHMIC" 
echo "Difficulty: MEDIUM"
echo "Description: Pattern matching, suffix trees, Burrows-Wheeler transform (Challenge CH-0000031)"
echo ""
