#!/bin/bash
# WE3 Challenge Implementation: CH-0000099
# Title: String Algorithms #99
...
echo "=== WE3 Challenge CH-0000099 ==="
echo "Title: String Algorithms #99"
echo "Category: ALGORITHMIC" 
echo "Difficulty: EASY"
echo "Description: Pattern matching, suffix trees, Burrows-Wheeler transform (Challenge CH-0000099)"
echo ""
