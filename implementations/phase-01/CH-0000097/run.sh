#!/bin/bash
# WE3 Challenge Implementation: CH-0000097
# Title: String Algorithms #97
...
echo "=== WE3 Challenge CH-0000097 ==="
echo "Title: String Algorithms #97"
echo "Category: ALGORITHMIC" 
echo "Difficulty: TRIVIAL"
echo "Description: Pattern matching, suffix trees, Burrows-Wheeler transform (Challenge CH-0000097)"
echo ""
