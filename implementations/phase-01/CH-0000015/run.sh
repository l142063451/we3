#!/bin/bash
# WE3 Challenge Implementation: CH-0000015
# Title: Dynamic Programming Solutions #15
...
echo "=== WE3 Challenge CH-0000015 ==="
echo "Title: Dynamic Programming Solutions #15"
echo "Category: ALGORITHMIC" 
echo "Difficulty: EASY"
echo "Description: Solve optimization problems using DP with memoization (Challenge CH-0000015)"
echo ""
